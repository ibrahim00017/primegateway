...
import { SpecifiqueComponent } from 'app/entities/specifique/specifique.component';
...
describe('Component Tests', () => {
  describe('Specifique Management Component', () => {
    let comp: SpecifiqueComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SpecifiqueComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(SpecifiqueComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(SpecifiqueService);
    });
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.specifiques && comp.specifiques[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
