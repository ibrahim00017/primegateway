...
describe('Fonction e2e test', () => {
  ...
  it('should load Fonctions', async () => {
    ...
    expect(await fonctionComponentsPage.getTitle()).to.eq('primegatewayApp.primeserviceFonction.home.title');
  ...
  it('should load create Fonction page', async () => {
    ...
    expect(await fonctionUpdatePage.getPageTitle()).to.eq('primegatewayApp.primeserviceFonction.home.createOrEditLabel');
  ...
  it('should create and save Fonctions', async () => {
    ...
    await promise.all([fonctionUpdatePage.setTitreInput('titre')]);

    expect(await fonctionUpdatePage.getTitreInput()).to.eq('titre', 'Expected Titre value to be equals to titre');
  ...
  it('should delete last Fonction', async () => {
    ...
    expect(await fonctionDeleteDialog.getDialogTitle()).to.eq('primegatewayApp.primeserviceFonction.delete.question');
